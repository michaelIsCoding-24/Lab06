...
myToDoList.push('Take out trash', 'Do the dishes', 'Conquer the world');
console.log('Step 2:', myToDoList);

myToDoList.splice(1, 1);
console.log('Step 3:', myToDoList)

var yourTodoList = ['Vacuum the floor', 'Mow the lawn'];
...
function addingMachine(x) {
       let sum = 0;
       // x.length refers to the length of the array
